        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="panel panel-default">
			  <div class="panel-heading">
				<h3 class="panel-title"><i class="glyphicon glyphicon-th"></i> [${param.name }]流程图</h3>
			  </div>
			  <div class="panel-heading">
				<img id="processDefImg" alt="流程定义图片"  src="${APP_PATH }/jquery/layer/skin/default/loading-0.gif">
			  </div>
			</div>
        </div>
      </div>
	...
	<script src="${APP_PATH }/jquery/jquery_form/jquery.form.js"></script>
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#processDefImg").attr("src","${APP_PATH}/process/doShowImg.do?id=${param.id}")
            });
