 ...
 <div class="navbar-wrapper">
      ...
      <div class="page-header">
		...
		<form role="form" style="margin-top:20px;">
		  <div class="form-group">
			...
			<input type="text" class="form-control" id="email" value="${sessionScope.member.email }" placeholder="请输入用于接收验证码的邮箱地址">
		  </div>
	...
	<script>
        ...
        $("#nextBtn").click(function(){
        	$.ajax({
				type : "POST",
				url : "${APP_PATH}/member/sendCheckMail.do",
				data : {
					email : $("#email").val()
				},
				beforeSend : function(){
				...
				error : function(){
					layer.msg("发送验证码失败！",result.message,{time:1000,icon:5,shift:6});
				}
			})
        })
	</script>
