        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#leftToRightBtn").click(function(){
			    	...
			    	var jsonObj = {
			    		userid : "${param.id}"//取请求参数中的id参数的值
			    	};
			    	
			    	$.each(selectedOptions,function(i,n){
			    		jsonObj["idList["+i+"]"] = n.value;
			    	});
			    	...
			    	$.ajax({
			    		...
			    		success : function(result){
			    			...
			    			if(result.success){
			    				...
			    				layer.msg(result.message, {time:1000, icon:2, shift:6});
			    			}
			    		},
			    		error : function(){
			    			layer.msg("添加角色失败！", {time:1000, icon:2, shift:6});
			    		}
			    	});
			    ...
			    $("#rightToLeftBtn").click(function(){
			    	...
			    	$.ajax({
			    		...
			    		error : function(){
			    			layer.msg("删除角色失败！", {time:1000, icon:2, shift:6});
			    		}
			    	});
			    });
            });
