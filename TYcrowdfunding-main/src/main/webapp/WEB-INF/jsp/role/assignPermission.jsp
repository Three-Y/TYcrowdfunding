	...
	<script type="text/javascript" src="${APP_PATH }/jquery/layer/layer.js"></script>
        <script type="text/javascript">
            $(function () {
				...
				var setting = {
                    check : {
                        enable : true //在节点前显示复选框
                    },
					view: {
						selectedMulti: false,//是否允许选择多个复选框
					...
					async: {
						enable: true,//采用异步加载树数据
						url:"${APP_PATH}/role/doDataAsync.do?roleid=${param.roleid}",
						autoParam:["id", "name=n", "level=lv"]//用于传递treeNode的参数，id表示传treeNode的id，如果加等号，如"id=abc"，表示传treeNode的id，参数名是abc
						//若想传递其它参数，otherParam : [],
					},
					callback: {
